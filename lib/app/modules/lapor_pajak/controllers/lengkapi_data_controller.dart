...
class LengkapiDataController extends GetxController {
  ...
  void onInit() {
    ...
    ValueJenisPajak = dataArgument.jenispajak;
  ...
  Future ProsesData() async {
    ...
    var request = http.MultipartRequest(
        "POST", Uri.parse("${URL_APP}/upload_image/update_daftarwp.php"));
    ...
    if (response.statusCode == 200) {
      ...
      sendPushMessage_topic(
          "operatorpejabat",
          "Pendaftaran Wajib Pajak Lama masuk!",
