...
class LengkapiDataView extends StatefulWidget {
  const LengkapiDataView({Key? key}) : super(key: key);

  @override
  _LengkapiDataViewState createState() => _LengkapiDataViewState();
}

class _LengkapiDataViewState extends State<LengkapiDataView> {
  final controller = Get.find<LengkapiDataController>();
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  GetBuilder<LengkapiDataController>(
                    init: LengkapiDataController(),
                    builder: (controller) {
                      return SizedBox(
                        height: 200.h,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<LengkapiDataController>(
          init: LengkapiDataController(),
          builder: (controller) {
            return Stepper(
