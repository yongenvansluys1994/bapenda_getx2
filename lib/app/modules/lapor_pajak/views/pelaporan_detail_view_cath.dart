...
class PelaporanDetailViewCath extends GetView<PelaporanDetailController> {
  PelaporanDetailViewCath({Key? key}) : super(key: key);
                            ...
                            : Container(
                                ...
                                child: Column(
                                  children: [
                                    SizedBox(height: 5),
                                    Texts.headline6(
                                        "Pelaporan Pajak ${Get.parameters['jenispajak']}",
                                        isBold: true,
                                        color: Colors.white),
                                    Padding(
