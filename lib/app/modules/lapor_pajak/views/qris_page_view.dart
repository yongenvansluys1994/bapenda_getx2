...
class QrisPageView extends GetView<QrisPageController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: "QRIS Payment", leading: true, isLogin: true),
      body: GetBuilder<QrisPageController>(
        init: QrisPageController(Get.find<Api>()),
        builder: (controller) {
