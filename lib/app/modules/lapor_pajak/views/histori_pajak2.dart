...
class HistoryPajak2 extends StatelessWidget {
  HistoryPajak2({super.key, required String id_wajib_pajak});
      ...
      builder: (controller) {
        ...
        return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var item = controller.datalist2[index];
