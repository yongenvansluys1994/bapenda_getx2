...
class HistoryPajak4 extends StatelessWidget {
  HistoryPajak4({super.key, required String id_wajib_pajak});
      ...
      builder: (controller) {
        ...
        return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var item = controller.datalist4[index];
