...
//
//     final modelKartuData = modelKartuDataFromJson(jsonString);

import 'dart:convert';

ModelKartuData modelKartuDataFromJson(String str) =>
    ModelKartuData.fromJson(json.decode(str));

String modelKartuDataToJson(ModelKartuData data) => json.encode(data.toJson());

class ModelKartuData {
  ModelKartuData({
  ...
  factory ModelKartuData.fromJson(Map<String, dynamic> json) => ModelKartuData(
